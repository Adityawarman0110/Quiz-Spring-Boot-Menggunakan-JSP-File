...
<head>
  ...
  <title>Quiz Java Spring | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>M</b><b>U</b><b>F</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Mandiri</b>Finance</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="${pageContext.request.contextPath }/resources/dist/img/pp.png" class="user-image" alt="User Image">
              <span class="hidden-xs">Aditya Warman Agustian</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="${pageContext.request.contextPath }/resources/dist/img/pp.png" class="img-circle" alt="User Image">

                <p>
                  Aditya Warman Agustian - Web Developer
                  <small>Karyawan Mandiri Utama Finance</small>
                </p>
              </li>
              <!-- Menu Body -->
              <!-- Menu Footer-->
...
<%--             <li class="active"><a href="${pageContext.request.contextPath }/admin/dashboard/dashboard1"><i class="fa fa-circle-o"></i> Dashboard v1</a></li> --%>
<%--             <li><a href="${pageContext.request.contextPath }/admin/dashboard/dashboard2"><i class="fa fa-circle-o"></i> Dashboard v2</a></li> --%>
<!--           </ul> -->
<!--         </li> -->
<%--         <li><a href="${pageContext.request.contextPath }/admin/master/student"><i class="fa fa-circle-o"></i> Student</a></li> --%>
...
<!--         <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Information</span></a></li> -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://adminlte.io">Admin Mandiri Utama Finanace</a>.</strong> All rights
    reserved.
  </footer>
